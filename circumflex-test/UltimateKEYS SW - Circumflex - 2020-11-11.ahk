; UltimateKEYS SW - Circumflex - 2020-11-11.ahk
...
dkRingDotAbove.item["d"] := "{u+00f0}"          ; (ð) small letter eth
dkRingDotAbove.item["D"] := "{u+00d0}"          ; (Ð) capital letter eth
dkRingDotAbove.item[chr(0x00ea)] := "{u+1e0b}"  ; (ê -> ḋ) d with dot above
dkRingDotAbove.item[chr(0x00ca)] := "{u+1e0a}"  ; (Ê -> Ḋ) D with dot above
...
dkRingDotAbove.item["o"] := "{u+00f8}"          ; (ø) o with stroke
dkRingDotAbove.item["O"] := "{u+00d8}"          ; (ø) O with stroke
dkRingDotAbove.item[chr(0x00f6)] := "{u+022f}"  ; (ö -> ȯ) o with dot above
dkRingDotAbove.item[chr(0x00d6)] := "{u+022e}"  ; (Ö -> Ȯ) O with dot above
...
dkRingDotAbove.item["t"] := "{u+00fe}"          ; (þ) small letter thorn
dkRingDotAbove.item["T"] := "{u+00de}"          ; (Þ) capital letter thorn
dkRingDotAbove.item[chr(0x00fb)] := "{u+1e6b}"  ; (û -> ṫ) t with dot above
dkRingDotAbove.item[chr(0x00db)] := "{u+1e6a}"  ; (Û -> Ṫ) T with dot above
...
dkRingDotAbove.item[chr(0x00e2)] := "{u+1e98}"  ; (â -> ẘ) w with ring above
...
dkMacronStroke.item[chr(0x00f4)] := "{u+1e3b}"  ; (ô -> ḻ) l with line below
dkMacronStroke.item[chr(0x00d4)] := "{u+1e3a}"  ; (Ô -> Ḻ) L with line below
...
dkAcuteAccent.item[chr(0x00e2)] := "{u+01fb}"  ; (â -> ǻ) a with ring above and acute
dkAcuteAccent.item[chr(0x00c2)] := "{u+01fa}"  ; (Â -> Ǻ) A with ring above and acute
...
dkGraveAccent.item[chr(0x00f4)] := "{u+20a4}"  ; (ô -> ₤) lira
dkGraveAccent.item[chr(0x00d4)] := "{u+20b6}"  ; (Ô -> ₶) livre tournois
