...
; UltimateKEYS - Grave Accent mod (for AutoHotkey v1.1).ahk - 2024-11-30
...
dkGrave.item[chr(34)] := "{u+266b}"  ; (♫) beamed eighth notes
dkGrave.item["\"] := "\"         ;     reverse solidus (backslash)
dkGrave.item["|"] := "|"         ;     vertical line
