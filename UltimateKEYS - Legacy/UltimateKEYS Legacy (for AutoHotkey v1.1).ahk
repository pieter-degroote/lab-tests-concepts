...
compose.item["2t"] := "{u+26a0}"  ; (⚠) warning sign
compose.item["2u"] := "{u+26a1}"  ; (⚡) high voltage sign
compose.item["2v"] := "{u+26d4}"  ; (⛔) no entry
compose.item["2w"] := "{u+231a}"  ; (⌚) watch
compose.item["2x"] := "{u+231b}"  ; (⌛) hourglass
