; UltimateKEYS SW - 2020-05-19.ahk
...
dkCaron.item("#") := "ǯ"  ; (u+01ef) small letter ezh with caron
dkCaron.item("3") := "Ǯ"  ; (u+01ee) capital letter ezh with caron
...
dkBreveSpecial.item("#") := "ʒ"  ; (u+0292) small letter ezh
dkBreveSpecial.item("3") := "Ʒ"  ; (u+01b7) capital letter ezh
