...
; EurKEY v1.1 (unofficial) (for AutoHotkey v2).ahk - 2024-10-14
...
dkCaron[chr(0x00f0)] := "{u+01c6}"  ; (ð -> ǆ) dz with caron
dkCaron[chr(0x00d0)] := "{u+01c5}"  ; (Ð -> ǅ) capital D with small z with caron
...
dkMacron["g"] := "{u+1e21}"  ; (ḡ) g with macron
dkMacron["G"] := "{u+1e20}"  ; (Ḡ) G with macron
...
dkMacron["l"] := "{u+1e3b}"  ; (ḻ) l with line below
dkMacron["L"] := "{u+1e3a}"  ; (Ḻ) L with line below
...
dkAcuteAccent["l"] := "{u+0142}"  ; (ł) l with stroke
dkAcuteAccent["L"] := "{u+0141}"  ; (Ł) L with stroke
...
dkSymbols["g"] := "{u+00b0}"  ; (°) degree sign
dkSymbols["G"] := "{u+00b0}"  ; (°) degree sign
dkSymbols["o"] := "{u+00b0}"  ; (°) degree sign
dkSymbols["O"] := "{u+00b0}"  ; (°) degree sign
...
dkGreekAlphabet[" "] := "{u+03a9}"  ; (Ω) capital omega
