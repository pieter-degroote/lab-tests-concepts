; UltimateKEYS - KBDUSX - 2020-06-28 (for AutoHotkey v2.0 alpha).ahk
...
dkGraveAccent["!"] := "{u+2000}"  ; en quad
dkGraveAccent["@"] := "{u+2001}"  ; em quad
...
dkNotSign["1"] := "{u+2190}"          ; (←) leftwards arrow
dkNotSign["2"] := "{u+2193}"          ; (↓) downwards arrow
dkNotSign["3"] := "{u+2191}"          ; (↑) upwards arrow
dkNotSign["4"] := "{u+2192}"          ; (→) rightwards arrow
dkNotSign["5"] := "{u+2196}"          ; (↖) north west arrow
dkNotSign["6"] := "{u+2199}"          ; (↙) south west arrow
dkNotSign["7"] := "{u+2197}"          ; (↗) north east arrow
dkNotSign["8"] := "{u+2198}"          ; (↘) south east arrow
dkNotSign["9"] := "{u+2195}"          ; (↕) up down arrow
dkNotSign["0"] := "{u+21a8}"          ; (↨) up down arrow with base
dkNotSign["="] := "{u+2194}"          ; (↔) left right arrow
dkNotSign["!"] := "{u+21d0}"          ; (⇐) leftwards double arrow
dkNotSign["@"] := "{u+21d3}"          ; (⇓) downwards double arrow
dkNotSign["#"] := "{u+21d1}"          ; (⇑) upwards double arrow
dkNotSign["$"] := "{u+21d2}"          ; (⇒) rightwards double arrow
dkNotSign["%"] := "{u+21d6}"          ; (⇖) north west double arrow
dkNotSign["^"] := "{u+21d9}"          ; (⇙) south west double arrow
dkNotSign["&"] := "{u+21d7}"          ; (⇗) north east double arrow
dkNotSign["*"] := "{u+21d8}"          ; (⇘) south east double arrow
dkNotSign["("] := "{u+21d5}"          ; (⇕) up down double arrow
dkNotSign[")"] := "{u+21b2}"          ; (↲) downwards arrow with tip leftwards
