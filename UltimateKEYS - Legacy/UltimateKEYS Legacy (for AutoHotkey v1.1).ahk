...
; UltimateKEYS Legacy (for AutoHotkey v1.1).ahk - 2025-02-10
...
compose.item["1a"] := "{u+2600}"  ; (☀) black sun with rays
compose.item["1b"] := "{u+2601}"  ; (☁) cloud
compose.item["1c"] := "{u+2602}"  ; (☂) umbrella
compose.item["1d"] := "{u+2603}"  ; (☃) snowman
compose.item["1e"] := "{u+2604}"  ; (☄) comet
compose.item["1f"] := "{u+2605}"  ; (★) black star
compose.item["1g"] := "{u+2606}"  ; (☆) white star
compose.item["1h"] := "{u+260e}"  ; (☎) black telephone
compose.item["1i"] := "{u+260f}"  ; (☏) white telephone
compose.item["1j"] := "{u+2610}"  ; (☐) ballot box
compose.item["1k"] := "{u+2611}"  ; (☑) ballot box with check
compose.item["1l"] := "{u+2612}"  ; (☒) ballot box with x
compose.item["1m"] := "{u+2619}"  ; (☙) reversed rotated floral heart bullet
compose.item["1n"] := "{u+261a}"  ; (☚) black left-pointing index
compose.item["1o"] := "{u+261b}"  ; (☛) black right-pointing index
compose.item["1p"] := "{u+261c}"  ; (☜) white left-pointing index
compose.item["1q"] := "{u+261d}"  ; (☝) white up-pointing index
compose.item["1r"] := "{u+261e}"  ; (☞) white right-pointing index
compose.item["1s"] := "{u+261f}"  ; (☟) white down-pointing index
compose.item["1t"] := "{u+2620}"  ; (☠) skull and crossbones
compose.item["1u"] := "{u+2621}"  ; (☡) caution sign
compose.item["1v"] := "{u+2622}"  ; (☢) radioactive sign
compose.item["1w"] := "{u+2623}"  ; (☣) biohazard sign
compose.item["1x"] := "{u+2639}"  ; (☹) white frowning face
compose.item["1y"] := "{u+263a}"  ; (☺) white smiling face
compose.item["1z"] := "{u+263b}"  ; (☻) black smiling face

compose.item["2a"] := "{u+263c}"  ; (☼) white sun with rays
compose.item["2b"] := "{u+263d}"  ; (☽) first quarter moon
compose.item["2c"] := "{u+263e}"  ; (☾) last quarter moon
compose.item["2d"] := "{u+2640}"  ; (♀) female sign (Venus)
compose.item["2e"] := "{u+2642}"  ; (♂) male sign (Mars)
compose.item["2f"] := "{u+2668}"  ; (♨) hot springs
compose.item["2g"] := "{u+2669}"  ; (♩) quarter note
compose.item["2h"] := "{u+266a}"  ; (♪) eighth note
compose.item["2i"] := "{u+266b}"  ; (♫) beamed eighth notes
compose.item["2j"] := "{u+266c}"  ; (♬) beamed sixteenth notes
compose.item["2k"] := "{u+266d}"  ; (♭) music flat sign
compose.item["2l"] := "{u+266e}"  ; (♮) music natural sign
compose.item["2m"] := "{u+266f}"  ; (♯) music sharp sign
compose.item["2n"] := "{u+2672}"  ; (♲) universal recycling symbol
compose.item["2o"] := "{u+267a}"  ; (♺) recycling symbol for generic materials
compose.item["2p"] := "{u+267b}"  ; (♻) black universal recycling symbol
compose.item["2q"] := "{u+267f}"  ; (♿) wheelchair symbol
compose.item["2r"] := "{u+2690}"  ; (⚐) white flag
compose.item["2s"] := "{u+2691}"  ; (⚑) black flag
compose.item["2t"] := "{u+269b}"  ; (⚛) atom symbol
compose.item["2u"] := "{u+26a0}"  ; (⚠) warning sign
compose.item["2v"] := "{u+26a1}"  ; (⚡) high voltage sign
compose.item["2w"] := "{u+26d4}"  ; (⛔) no entry
compose.item["2x"] := "{u+231a}"  ; (⌚) watch
compose.item["2y"] := "{u+231b}"  ; (⌛) hourglass

compose.item["3a"] := "{u+2701}"  ; (✁) upper blade scissors
compose.item["3b"] := "{u+2702}"  ; (✂) black scissors
compose.item["3c"] := "{u+2703}"  ; (✃) lower blade scissors
compose.item["3d"] := "{u+2704}"  ; (✄) white scissors
compose.item["3e"] := "{u+2706}"  ; (✆) telephone location sign
compose.item["3f"] := "{u+2707}"  ; (✇) tape drive
compose.item["3g"] := "{u+2708}"  ; (✈) airplane
compose.item["3h"] := "{u+2709}"  ; (✉) envelope
compose.item["3i"] := "{u+270a}"  ; (✊) raised fist
compose.item["3j"] := "{u+270b}"  ; (✋) raised hand
compose.item["3k"] := "{u+270c}"  ; (✌) victory hand
compose.item["3l"] := "{u+270d}"  ; (✍) writing hand
compose.item["3m"] := "{u+270e}"  ; (✎) lower right pencil
compose.item["3n"] := "{u+270f}"  ; (✏) pencil
compose.item["3o"] := "{u+2710}"  ; (✐) upper right pencil
compose.item["3p"] := "{u+2711}"  ; (✑) white nib
compose.item["3q"] := "{u+2712}"  ; (✒) black nib
compose.item["3r"] := "{u+2713}"  ; (✓) check mark
compose.item["3s"] := "{u+2714}"  ; (✔) heavy check mark
compose.item["3t"] := "{u+2715}"  ; (✕) multiplication x
compose.item["3u"] := "{u+2716}"  ; (✖) heavy multiplication x
compose.item["3v"] := "{u+2717}"  ; (✗) ballot x
compose.item["3w"] := "{u+2718}"  ; (✘) heavy ballot x
compose.item["3x"] := "{u+2719}"  ; (✙) outlined Greek cross
compose.item["3y"] := "{u+271a}"  ; (✚) heavy Greek cross
compose.item["3z"] := "{u+271b}"  ; (✛) open centre cross

compose.item["4a"] := "{u+271c}"  ; (✜) heavy open centre cross
compose.item["4b"] := "{u+271d}"  ; (✝) Latin cross
compose.item["4c"] := "{u+271e}"  ; (✞) shadowed white Latin cross
compose.item["4d"] := "{u+271f}"  ; (✟) outlined Latin cross
compose.item["4e"] := "{u+2720}"  ; (✠) Maltese cross
compose.item["4f"] := "{u+2721}"  ; (✡) star of David
compose.item["4g"] := "{u+2722}"  ; (✢) four teardrop-spoked asterisk
compose.item["4h"] := "{u+2723}"  ; (✣) four balloon-spoked asterisk
compose.item["4i"] := "{u+2724}"  ; (✤) heavy four balloon-spoked asterisk
compose.item["4j"] := "{u+2725}"  ; (✥) four club-spoked asterisk
compose.item["4k"] := "{u+2726}"  ; (✦) black four-pointed star
compose.item["4l"] := "{u+2727}"  ; (✧) white four-pointed star
compose.item["4m"] := "{u+2729}"  ; (✩) stress outlined white star
compose.item["4n"] := "{u+272a}"  ; (✪) circled white star
compose.item["4o"] := "{u+272b}"  ; (✫) open centre black star
compose.item["4p"] := "{u+272c}"  ; (✬) black centre white star
compose.item["4q"] := "{u+272d}"  ; (✭) outlined black star
compose.item["4r"] := "{u+272e}"  ; (✮) heavy outlined black star
compose.item["4s"] := "{u+272f}"  ; (✯) pinwheel star
compose.item["4t"] := "{u+2730}"  ; (✰) shadowed white star
compose.item["4u"] := "{u+2731}"  ; (✱) heavy asterisk
compose.item["4v"] := "{u+2732}"  ; (✲) open centre asterisk
compose.item["4w"] := "{u+2733}"  ; (✳) eight-spoked asterisk
compose.item["4x"] := "{u+2734}"  ; (✴) eight-pointed black star
compose.item["4y"] := "{u+2735}"  ; (✵) eight-pointed pinwheel star
compose.item["4z"] := "{u+2736}"  ; (✶) six-pointed black star

compose.item["5a"] := "{u+2737}"  ; (✷) eight-pointed rectilinear black star
compose.item["5b"] := "{u+2738}"  ; (✸) heavy eight-pointed rectilinear black star
compose.item["5c"] := "{u+2739}"  ; (✹) twelve pointed black star
compose.item["5d"] := "{u+273a}"  ; (✺) sixteen-pointed asterisk
compose.item["5e"] := "{u+273b}"  ; (✻) teardrop-spoked asterisk
compose.item["5f"] := "{u+273c}"  ; (✼) open centre teardrop-spoked asterisk
compose.item["5g"] := "{u+273d}"  ; (✽) heavy teardrop-spoked asterisk
compose.item["5h"] := "{u+273e}"  ; (✾) six-petalled black and white florette
compose.item["5i"] := "{u+273f}"  ; (✿) black florette
compose.item["5j"] := "{u+2740}"  ; (❀) white florette
compose.item["5k"] := "{u+2741}"  ; (❁) eight-petalled outlined black florette
compose.item["5l"] := "{u+2742}"  ; (❂) circled open centre eight-pointed star
compose.item["5m"] := "{u+2743}"  ; (❃) heavy teardrop-spoked pinwheel asterisk
compose.item["5n"] := "{u+2744}"  ; (❄) snowflake
compose.item["5o"] := "{u+2745}"  ; (❅) tight trifoliate snowflake
compose.item["5p"] := "{u+2746}"  ; (❆) heavy chevron snowflake
compose.item["5q"] := "{u+2747}"  ; (❇) sparkle
compose.item["5r"] := "{u+2748}"  ; (❈) heavy sparkle
compose.item["5s"] := "{u+2749}"  ; (❉) balloon-spoked asterisk
compose.item["5t"] := "{u+274a}"  ; (❊) eight teardrop-spoked propeller asterisk
compose.item["5u"] := "{u+274b}"  ; (❋) heavy eight teardrop-spoked propeller asterisk
compose.item["5v"] := "{u+274d}"  ; (❍) shadowed white circle
compose.item["5w"] := "{u+274f}"  ; (❏) lower right drop-shadowed white square
compose.item["5x"] := "{u+2750}"  ; (❐) upper right drop-shadowed white square
compose.item["5y"] := "{u+2751}"  ; (❑) lower right shadowed white square
compose.item["5z"] := "{u+2752}"  ; (❒) upper right shadowed white square

compose.item["6a"] := "{u+2756}"  ; (❖) black diamond minus white x
compose.item["6b"] := "{u+2758}"  ; (❘) light vertical bar
compose.item["6c"] := "{u+2759}"  ; (❙) medium vertical bar
compose.item["6d"] := "{u+275a}"  ; (❚) heavy vertical bar
compose.item["6e"] := "{u+275b}"  ; (❛) heavy single turned comma quotation mark ornament
compose.item["6f"] := "{u+275c}"  ; (❜) heavy single comma quotation mark ornament
compose.item["6g"] := "{u+275d}"  ; (❝) heavy double turned comma quotation mark ornament
compose.item["6h"] := "{u+275e}"  ; (❞) heavy double comma quotation mark ornament
compose.item["6i"] := "{u+275f}"  ; (❟) heavy low single comma quotation mark ornament
compose.item["6j"] := "{u+2760}"  ; (❠) heavy low double comma quotation mark ornament
compose.item["6k"] := "{u+2761}"  ; (❡) curved stem paragraph sign ornament
compose.item["6l"] := "{u+2762}"  ; (❢) heavy exclamation mark ornament
compose.item["6m"] := "{u+2763}"  ; (❣) heavy heart exclamation mark ornament
compose.item["6n"] := "{u+2764}"  ; (❤) heavy black heart
compose.item["6o"] := "{u+2765}"  ; (❥) rotated heavy black heart bullet
compose.item["6p"] := "{u+2766}"  ; (❦) floral heart
compose.item["6q"] := "{u+2767}"  ; (❧) rotated floral heart bullet

compose.item["7a"] := "{u+2794}"  ; (➔) heavy wide-headed rightwards arrow
compose.item["7b"] := "{u+2798}"  ; (➘) heavy south east arrow
compose.item["7c"] := "{u+2799}"  ; (➙) heavy rightwards arrow
compose.item["7d"] := "{u+279a}"  ; (➚) heavy north east arrow
compose.item["7e"] := "{u+279b}"  ; (➛) drafting point rightwards arrow
compose.item["7f"] := "{u+279c}"  ; (➜) heavy round-tipped rightwards arrow
compose.item["7g"] := "{u+279d}"  ; (➝) triangle-headed rightwards arrow
compose.item["7h"] := "{u+279e}"  ; (➞) heavy triangle-headed rightwards arrow
compose.item["7i"] := "{u+279f}"  ; (➟) dashed triangle-headed rightwards arrow
compose.item["7j"] := "{u+27a0}"  ; (➠) heavy dashed triangle-headed rightwards arrow
compose.item["7k"] := "{u+27a1}"  ; (➡) black rightwards arrow
compose.item["7l"] := "{u+27a2}"  ; (➢) 3d top-lighted rightwards arrowhead
compose.item["7m"] := "{u+27a3}"  ; (➣) 3d bottom-lighted rightwards arrowhead
compose.item["7n"] := "{u+27a4}"  ; (➤) black rightwards arrowhead
compose.item["7o"] := "{u+27a5}"  ; (➥) heavy black curved downwards and rightwards arrow
compose.item["7p"] := "{u+27a6}"  ; (➦) heavy black curved upwards and rightwards arrow
compose.item["7q"] := "{u+27a7}"  ; (➧) squat black rightwards arrow
compose.item["7r"] := "{u+27a8}"  ; (➨) heavy concave-pointed black rightwards arrow
compose.item["7s"] := "{u+27a9}"  ; (➩) right-shaded white rightwards arrow
compose.item["7t"] := "{u+27aa}"  ; (➪) left-shaded white rightwards arrow
compose.item["7u"] := "{u+27ab}"  ; (➫) back-tilted shadowed white rightwards arrow
compose.item["7v"] := "{u+27ac}"  ; (➬) front-tilted shadowed white rightwards arrow
compose.item["7w"] := "{u+27ad}"  ; (➭) heavy lower right-shadowed white rightwards arrow
compose.item["7x"] := "{u+27ae}"  ; (➮) heavy upper right-shadowed white rightwards arrow
compose.item["7y"] := "{u+27af}"  ; (➯) notched lower right-shadowed white rightwards arrow
compose.item["7z"] := "{u+27b1}"  ; (➱) notched upper right-shadowed white rightwards arrow

compose.item["8a"] := "{u+27b2}"  ; (➲) circled heavy white rightwards arrow
compose.item["8b"] := "{u+27b3}"  ; (➳) white-feathered rightwards arrow
compose.item["8c"] := "{u+27b4}"  ; (➴) black-feathered south east arrow
compose.item["8d"] := "{u+27b5}"  ; (➵) black-feathered rightwards arrow
compose.item["8e"] := "{u+27b6}"  ; (➶) black-feathered north east arrow
compose.item["8f"] := "{u+27b7}"  ; (➷) heavy black-feathered south east arrow
compose.item["8g"] := "{u+27b8}"  ; (➸) heavy black-feathered rightwards arrow
compose.item["8h"] := "{u+27b9}"  ; (➹) heavy black-feathered north east arrow
compose.item["8i"] := "{u+27ba}"  ; (➺) teardrop-barbed rightwards arrow
compose.item["8j"] := "{u+27bb}"  ; (➻) heavy teardrop-shanked rightwards arrow
compose.item["8k"] := "{u+27bc}"  ; (➼) wedge-tailed rightwards arrow
compose.item["8l"] := "{u+27bd}"  ; (➽) heavy wedge-tailed rightwards arrow
compose.item["8m"] := "{u+27be}"  ; (➾) open-outlined rightwards arrow
compose.item["8n"] := "{u+27c1}"  ; (⟁) white triangle containing small white triangle


; Compose :  Dingbat Negative Circled Digits

compose.item["n1"] := "{u+2776}"  ; (❶) dingbat negative circled digit 1
compose.item["n2"] := "{u+2777}"  ; (❷) dingbat negative circled digit 2
compose.item["n3"] := "{u+2778}"  ; (❸) dingbat negative circled digit 3
compose.item["n4"] := "{u+2779}"  ; (❹) dingbat negative circled digit 4
compose.item["n5"] := "{u+277a}"  ; (❺) dingbat negative circled digit 5
compose.item["n6"] := "{u+277b}"  ; (❻) dingbat negative circled digit 6
compose.item["n7"] := "{u+277c}"  ; (❼) dingbat negative circled digit 7
compose.item["n8"] := "{u+277d}"  ; (❽) dingbat negative circled digit 8
compose.item["n9"] := "{u+277e}"  ; (❾) dingbat negative circled digit 9
compose.item["n0"] := "{u+277f}"  ; (❿) dingbat negative circled digit 10
