; UltimateKEYS - Grave Accent (for AutoHotkey v2.0).ahk - 2023-01-07
...
dkGrave["z"] := "{u+00e0}"  ; (à) a with grave
dkGrave["Z"] := "{u+00c0}"  ; (À) A with grave
dkGrave["x"] := "{u+00e1}"  ; (á) a with acute
dkGrave["X"] := "{u+00c1}"  ; (Á) A with acute
...
dkGrave["f"] := "{u+00e8}"  ; (è) e with grave
dkGrave["F"] := "{u+00c8}"  ; (È) E with grave
dkGrave["g"] := "{u+00e9}"  ; (é) e with acute
dkGrave["G"] := "{u+00c9}"  ; (É) E with acute
...
dkGrave["v"] := "{u+00ec}"  ; (ì) i with grave
dkGrave["V"] := "{u+00cc}"  ; (Ì) I with grave
dkGrave["b"] := "{u+00ed}"  ; (í) i with acute
dkGrave["B"] := "{u+00cd}"  ; (Í) I with acute
...
dkGrave["h"] := "{u+00f9}"  ; (ù) u with grave
dkGrave["H"] := "{u+00d9}"  ; (Ù) U with grave
dkGrave["j"] := "{u+00fa}"  ; (ú) u with acute
dkGrave["J"] := "{u+00da}"  ; (Ú) U with acute
...
dkGrave["2"] := "{u+2264}"  ; (≤) less-than or equal to
dkGrave["@"] := "{u+00b2}"  ; (²) superscript 2
dkGrave["3"] := "{u+2265}"  ; (≥) greater-than or equal to
dkGrave["#"] := "{u+00b3}"  ; (³) superscript 3
dkGrave["4"] := "{u+00a3}"  ; (£) pound sign
dkGrave["$"] := "{u+00a5}"  ; (¥) yen sign
dkGrave["5"] := "{u+20ac}"  ; (€) euro sign
dkGrave["%"] := "{u+00a2}"  ; (¢) cent sign (dollar)
dkGrave["6"] := "{u+00e3}"  ; (ã) a with tilde
dkGrave["^"] := "{u+00c3}"  ; (Ã) A with tilde
dkGrave["7"] := "{u+00f5}"  ; (õ) o with tilde
dkGrave["&"] := "{u+00d5}"  ; (Õ) O with tilde
...
dkGrave["?"] := "{u+2026}"  ; (…) horizontal ellipsis
dkGrave["'"] := "{u+2020}"  ; (†) dagger
dkGrave[chr(34)] := "{u+2021}"  ; (‡) double dagger
dkGrave["\"] := "{u+2002}"  ;     en space
dkGrave["|"] := "{u+2003}"  ;     em space
...
; Configuration :  'Grave Accent' as an alternate key for 'Right Alt'
