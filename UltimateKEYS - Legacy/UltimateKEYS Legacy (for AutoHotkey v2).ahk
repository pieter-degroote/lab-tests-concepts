...
; UltimateKEYS Legacy (for AutoHotkey v2).ahk - 2025-02-06
...
compose["2t"] := "{u+26a0}"  ; (⚠) warning sign
compose["2u"] := "{u+26a1}"  ; (⚡) high voltage sign
compose["2v"] := "{u+26d4}"  ; (⛔) no entry
compose["2w"] := "{u+231a}"  ; (⌚) watch
compose["2x"] := "{u+231b}"  ; (⌛) hourglass
