...
; UltimateKEYS - Grave Accent mod (for AutoHotkey v2).ahk - 2024-11-30
...
dkGrave["v"] := "{u+00ed}"  ; (í) i with acute
dkGrave["V"] := "{u+00cd}"  ; (Í) I with acute
dkGrave["b"] := "{u+00ec}"  ; (ì) i with grave
dkGrave["B"] := "{u+00cc}"  ; (Ì) I with grave
...
dkGrave[chr(34)] := "{u+266b}"  ; (♫) beamed eighth notes
dkGrave["\"] := "\"         ;     reverse solidus (backslash)
dkGrave["|"] := "|"         ;     vertical line
...
; Configuration :  'Grave Accent' and optional ISO key as alternate keys for 'Right Alt'
