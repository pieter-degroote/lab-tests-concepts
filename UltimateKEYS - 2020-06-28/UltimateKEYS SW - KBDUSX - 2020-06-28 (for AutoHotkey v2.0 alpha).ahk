; UltimateKEYS SW - KBDUSX - 2020-06-28 (for AutoHotkey v2.0 alpha).ahk
...
dkDiaeresis[chr(34)] := "{u+00a8}" ; (¨) diaeresis
...
dkGraveAccent["1"] := "{u+2000}"  ; en quad
dkGraveAccent["2"] := "{u+2001}"  ; em quad
...
dkNotSign["!"] := "{u+2190}"          ; (←) leftwards arrow
dkNotSign["@"] := "{u+2193}"          ; (↓) downwards arrow
dkNotSign["#"] := "{u+2191}"          ; (↑) upwards arrow
dkNotSign["$"] := "{u+2192}"          ; (→) rightwards arrow
dkNotSign["%"] := "{u+2196}"          ; (↖) north west arrow
dkNotSign["^"] := "{u+2199}"          ; (↙) south west arrow
dkNotSign["&"] := "{u+2197}"          ; (↗) north east arrow
dkNotSign["*"] := "{u+2198}"          ; (↘) south east arrow
dkNotSign["("] := "{u+2195}"          ; (↕) up down arrow
dkNotSign[")"] := "{u+21a8}"          ; (↨) up down arrow with base
dkNotSign["="] := "{u+2194}"          ; (↔) left right arrow
dkNotSign["1"] := "{u+21d0}"          ; (⇐) leftwards double arrow
dkNotSign["2"] := "{u+21d3}"          ; (⇓) downwards double arrow
dkNotSign["3"] := "{u+21d1}"          ; (⇑) upwards double arrow
dkNotSign["4"] := "{u+21d2}"          ; (⇒) rightwards double arrow
dkNotSign["5"] := "{u+21d6}"          ; (⇖) north west double arrow
dkNotSign["6"] := "{u+21d9}"          ; (⇙) south west double arrow
dkNotSign["7"] := "{u+21d7}"          ; (⇗) north east double arrow
dkNotSign["8"] := "{u+21d8}"          ; (⇘) south east double arrow
dkNotSign["9"] := "{u+21d5}"          ; (⇕) up down double arrow
dkNotSign["0"] := "{u+21b2}"          ; (↲) downwards arrow with tip leftwards
dkNotSign["+"] := "{u+21d4}"          ; (⇔) left right double arrow
...
dkBrokenBar["!"] := "{u+2116}"  ; (№) numero sign
dkBrokenBar["1"] := "{u+2116}"  ; (№) numero sign
dkBrokenBar["@"] := "{u+00bd}"  ; (½) vulgar fraction 1/2
dkBrokenBar["2"] := "{u+00bd}"  ; (½) vulgar fraction 1/2
dkBrokenBar["#"] := "{u+2153}"  ; (⅓) vulgar fraction 1/3
dkBrokenBar["3"] := "{u+2153}"  ; (⅓) vulgar fraction 1/3
dkBrokenBar["$"] := "{u+00bc}"  ; (¼) vulgar fraction 1/4
dkBrokenBar["4"] := "{u+00bc}"  ; (¼) vulgar fraction 1/4
dkBrokenBar["%"] := "{u+2154}"  ; (⅔) vulgar fraction 2/3
dkBrokenBar["5"] := "{u+2154}"  ; (⅔) vulgar fraction 2/3
dkBrokenBar["^"] := "{u+00be}"  ; (¾) vulgar fraction 3/4
dkBrokenBar["6"] := "{u+00be}"  ; (¾) vulgar fraction 3/4
dkBrokenBar["&"] := "{u+215b}"  ; (⅛) vulgar fraction 1/8
dkBrokenBar["7"] := "{u+215b}"  ; (⅛) vulgar fraction 1/8
dkBrokenBar["*"] := "{u+215c}"  ; (⅜) vulgar fraction 3/8
dkBrokenBar["8"] := "{u+215c}"  ; (⅜) vulgar fraction 3/8
dkBrokenBar["("] := "{u+215d}"  ; (⅝) vulgar fraction 5/8
dkBrokenBar["9"] := "{u+215d}"  ; (⅝) vulgar fraction 5/8
dkBrokenBar[")"] := "{u+215e}"  ; (⅞) vulgar fraction 7/8
dkBrokenBar["0"] := "{u+215e}"  ; (⅞) vulgar fraction 7/8
