...
; UltimateKEYS Legacy (for AutoHotkey v2).ahk - 2025-02-10
...
compose["1a"] := "{u+2600}"  ; (☀) black sun with rays
compose["1b"] := "{u+2601}"  ; (☁) cloud
compose["1c"] := "{u+2602}"  ; (☂) umbrella
compose["1d"] := "{u+2603}"  ; (☃) snowman
compose["1e"] := "{u+2604}"  ; (☄) comet
compose["1f"] := "{u+2605}"  ; (★) black star
compose["1g"] := "{u+2606}"  ; (☆) white star
compose["1h"] := "{u+260e}"  ; (☎) black telephone
compose["1i"] := "{u+260f}"  ; (☏) white telephone
compose["1j"] := "{u+2610}"  ; (☐) ballot box
compose["1k"] := "{u+2611}"  ; (☑) ballot box with check
compose["1l"] := "{u+2612}"  ; (☒) ballot box with x
compose["1m"] := "{u+2619}"  ; (☙) reversed rotated floral heart bullet
compose["1n"] := "{u+261a}"  ; (☚) black left-pointing index
compose["1o"] := "{u+261b}"  ; (☛) black right-pointing index
compose["1p"] := "{u+261c}"  ; (☜) white left-pointing index
compose["1q"] := "{u+261d}"  ; (☝) white up-pointing index
compose["1r"] := "{u+261e}"  ; (☞) white right-pointing index
compose["1s"] := "{u+261f}"  ; (☟) white down-pointing index
compose["1t"] := "{u+2620}"  ; (☠) skull and crossbones
compose["1u"] := "{u+2621}"  ; (☡) caution sign
compose["1v"] := "{u+2622}"  ; (☢) radioactive sign
compose["1w"] := "{u+2623}"  ; (☣) biohazard sign
compose["1x"] := "{u+2639}"  ; (☹) white frowning face
compose["1y"] := "{u+263a}"  ; (☺) white smiling face
compose["1z"] := "{u+263b}"  ; (☻) black smiling face

compose["2a"] := "{u+263c}"  ; (☼) white sun with rays
compose["2b"] := "{u+263d}"  ; (☽) first quarter moon
compose["2c"] := "{u+263e}"  ; (☾) last quarter moon
compose["2d"] := "{u+2640}"  ; (♀) female sign (Venus)
compose["2e"] := "{u+2642}"  ; (♂) male sign (Mars)
compose["2f"] := "{u+2668}"  ; (♨) hot springs
compose["2g"] := "{u+2669}"  ; (♩) quarter note
compose["2h"] := "{u+266a}"  ; (♪) eighth note
compose["2i"] := "{u+266b}"  ; (♫) beamed eighth notes
compose["2j"] := "{u+266c}"  ; (♬) beamed sixteenth notes
compose["2k"] := "{u+266d}"  ; (♭) music flat sign
compose["2l"] := "{u+266e}"  ; (♮) music natural sign
compose["2m"] := "{u+266f}"  ; (♯) music sharp sign
compose["2n"] := "{u+2672}"  ; (♲) universal recycling symbol
compose["2o"] := "{u+267a}"  ; (♺) recycling symbol for generic materials
compose["2p"] := "{u+267b}"  ; (♻) black universal recycling symbol
compose["2q"] := "{u+267f}"  ; (♿) wheelchair symbol
compose["2r"] := "{u+2690}"  ; (⚐) white flag
compose["2s"] := "{u+2691}"  ; (⚑) black flag
compose["2t"] := "{u+269b}"  ; (⚛) atom symbol
compose["2u"] := "{u+26a0}"  ; (⚠) warning sign
compose["2v"] := "{u+26a1}"  ; (⚡) high voltage sign
compose["2w"] := "{u+26d4}"  ; (⛔) no entry
compose["2x"] := "{u+231a}"  ; (⌚) watch
compose["2y"] := "{u+231b}"  ; (⌛) hourglass

compose["3a"] := "{u+2701}"  ; (✁) upper blade scissors
compose["3b"] := "{u+2702}"  ; (✂) black scissors
compose["3c"] := "{u+2703}"  ; (✃) lower blade scissors
compose["3d"] := "{u+2704}"  ; (✄) white scissors
compose["3e"] := "{u+2706}"  ; (✆) telephone location sign
compose["3f"] := "{u+2707}"  ; (✇) tape drive
compose["3g"] := "{u+2708}"  ; (✈) airplane
compose["3h"] := "{u+2709}"  ; (✉) envelope
compose["3i"] := "{u+270a}"  ; (✊) raised fist
compose["3j"] := "{u+270b}"  ; (✋) raised hand
compose["3k"] := "{u+270c}"  ; (✌) victory hand
compose["3l"] := "{u+270d}"  ; (✍) writing hand
compose["3m"] := "{u+270e}"  ; (✎) lower right pencil
compose["3n"] := "{u+270f}"  ; (✏) pencil
compose["3o"] := "{u+2710}"  ; (✐) upper right pencil
compose["3p"] := "{u+2711}"  ; (✑) white nib
compose["3q"] := "{u+2712}"  ; (✒) black nib
compose["3r"] := "{u+2713}"  ; (✓) check mark
compose["3s"] := "{u+2714}"  ; (✔) heavy check mark
compose["3t"] := "{u+2715}"  ; (✕) multiplication x
compose["3u"] := "{u+2716}"  ; (✖) heavy multiplication x
compose["3v"] := "{u+2717}"  ; (✗) ballot x
compose["3w"] := "{u+2718}"  ; (✘) heavy ballot x
compose["3x"] := "{u+2719}"  ; (✙) outlined Greek cross
compose["3y"] := "{u+271a}"  ; (✚) heavy Greek cross
compose["3z"] := "{u+271b}"  ; (✛) open centre cross

compose["4a"] := "{u+271c}"  ; (✜) heavy open centre cross
compose["4b"] := "{u+271d}"  ; (✝) Latin cross
compose["4c"] := "{u+271e}"  ; (✞) shadowed white Latin cross
compose["4d"] := "{u+271f}"  ; (✟) outlined Latin cross
compose["4e"] := "{u+2720}"  ; (✠) Maltese cross
compose["4f"] := "{u+2721}"  ; (✡) star of David
compose["4g"] := "{u+2722}"  ; (✢) four teardrop-spoked asterisk
compose["4h"] := "{u+2723}"  ; (✣) four balloon-spoked asterisk
compose["4i"] := "{u+2724}"  ; (✤) heavy four balloon-spoked asterisk
compose["4j"] := "{u+2725}"  ; (✥) four club-spoked asterisk
compose["4k"] := "{u+2726}"  ; (✦) black four-pointed star
compose["4l"] := "{u+2727}"  ; (✧) white four-pointed star
compose["4m"] := "{u+2729}"  ; (✩) stress outlined white star
compose["4n"] := "{u+272a}"  ; (✪) circled white star
compose["4o"] := "{u+272b}"  ; (✫) open centre black star
compose["4p"] := "{u+272c}"  ; (✬) black centre white star
compose["4q"] := "{u+272d}"  ; (✭) outlined black star
compose["4r"] := "{u+272e}"  ; (✮) heavy outlined black star
compose["4s"] := "{u+272f}"  ; (✯) pinwheel star
compose["4t"] := "{u+2730}"  ; (✰) shadowed white star
compose["4u"] := "{u+2731}"  ; (✱) heavy asterisk
compose["4v"] := "{u+2732}"  ; (✲) open centre asterisk
compose["4w"] := "{u+2733}"  ; (✳) eight-spoked asterisk
compose["4x"] := "{u+2734}"  ; (✴) eight-pointed black star
compose["4y"] := "{u+2735}"  ; (✵) eight-pointed pinwheel star
compose["4z"] := "{u+2736}"  ; (✶) six-pointed black star

compose["5a"] := "{u+2737}"  ; (✷) eight-pointed rectilinear black star
compose["5b"] := "{u+2738}"  ; (✸) heavy eight-pointed rectilinear black star
compose["5c"] := "{u+2739}"  ; (✹) twelve pointed black star
compose["5d"] := "{u+273a}"  ; (✺) sixteen-pointed asterisk
compose["5e"] := "{u+273b}"  ; (✻) teardrop-spoked asterisk
compose["5f"] := "{u+273c}"  ; (✼) open centre teardrop-spoked asterisk
compose["5g"] := "{u+273d}"  ; (✽) heavy teardrop-spoked asterisk
compose["5h"] := "{u+273e}"  ; (✾) six-petalled black and white florette
compose["5i"] := "{u+273f}"  ; (✿) black florette
compose["5j"] := "{u+2740}"  ; (❀) white florette
compose["5k"] := "{u+2741}"  ; (❁) eight-petalled outlined black florette
compose["5l"] := "{u+2742}"  ; (❂) circled open centre eight-pointed star
compose["5m"] := "{u+2743}"  ; (❃) heavy teardrop-spoked pinwheel asterisk
compose["5n"] := "{u+2744}"  ; (❄) snowflake
compose["5o"] := "{u+2745}"  ; (❅) tight trifoliate snowflake
compose["5p"] := "{u+2746}"  ; (❆) heavy chevron snowflake
compose["5q"] := "{u+2747}"  ; (❇) sparkle
compose["5r"] := "{u+2748}"  ; (❈) heavy sparkle
compose["5s"] := "{u+2749}"  ; (❉) balloon-spoked asterisk
compose["5t"] := "{u+274a}"  ; (❊) eight teardrop-spoked propeller asterisk
compose["5u"] := "{u+274b}"  ; (❋) heavy eight teardrop-spoked propeller asterisk
compose["5v"] := "{u+274d}"  ; (❍) shadowed white circle
compose["5w"] := "{u+274f}"  ; (❏) lower right drop-shadowed white square
compose["5x"] := "{u+2750}"  ; (❐) upper right drop-shadowed white square
compose["5y"] := "{u+2751}"  ; (❑) lower right shadowed white square
compose["5z"] := "{u+2752}"  ; (❒) upper right shadowed white square

compose["6a"] := "{u+2756}"  ; (❖) black diamond minus white x
compose["6b"] := "{u+2758}"  ; (❘) light vertical bar
compose["6c"] := "{u+2759}"  ; (❙) medium vertical bar
compose["6d"] := "{u+275a}"  ; (❚) heavy vertical bar
compose["6e"] := "{u+275b}"  ; (❛) heavy single turned comma quotation mark ornament
compose["6f"] := "{u+275c}"  ; (❜) heavy single comma quotation mark ornament
compose["6g"] := "{u+275d}"  ; (❝) heavy double turned comma quotation mark ornament
compose["6h"] := "{u+275e}"  ; (❞) heavy double comma quotation mark ornament
compose["6i"] := "{u+275f}"  ; (❟) heavy low single comma quotation mark ornament
compose["6j"] := "{u+2760}"  ; (❠) heavy low double comma quotation mark ornament
compose["6k"] := "{u+2761}"  ; (❡) curved stem paragraph sign ornament
compose["6l"] := "{u+2762}"  ; (❢) heavy exclamation mark ornament
compose["6m"] := "{u+2763}"  ; (❣) heavy heart exclamation mark ornament
compose["6n"] := "{u+2764}"  ; (❤) heavy black heart
compose["6o"] := "{u+2765}"  ; (❥) rotated heavy black heart bullet
compose["6p"] := "{u+2766}"  ; (❦) floral heart
compose["6q"] := "{u+2767}"  ; (❧) rotated floral heart bullet

compose["7a"] := "{u+2794}"  ; (➔) heavy wide-headed rightwards arrow
compose["7b"] := "{u+2798}"  ; (➘) heavy south east arrow
compose["7c"] := "{u+2799}"  ; (➙) heavy rightwards arrow
compose["7d"] := "{u+279a}"  ; (➚) heavy north east arrow
compose["7e"] := "{u+279b}"  ; (➛) drafting point rightwards arrow
compose["7f"] := "{u+279c}"  ; (➜) heavy round-tipped rightwards arrow
compose["7g"] := "{u+279d}"  ; (➝) triangle-headed rightwards arrow
compose["7h"] := "{u+279e}"  ; (➞) heavy triangle-headed rightwards arrow
compose["7i"] := "{u+279f}"  ; (➟) dashed triangle-headed rightwards arrow
compose["7j"] := "{u+27a0}"  ; (➠) heavy dashed triangle-headed rightwards arrow
compose["7k"] := "{u+27a1}"  ; (➡) black rightwards arrow
compose["7l"] := "{u+27a2}"  ; (➢) 3d top-lighted rightwards arrowhead
compose["7m"] := "{u+27a3}"  ; (➣) 3d bottom-lighted rightwards arrowhead
compose["7n"] := "{u+27a4}"  ; (➤) black rightwards arrowhead
compose["7o"] := "{u+27a5}"  ; (➥) heavy black curved downwards and rightwards arrow
compose["7p"] := "{u+27a6}"  ; (➦) heavy black curved upwards and rightwards arrow
compose["7q"] := "{u+27a7}"  ; (➧) squat black rightwards arrow
compose["7r"] := "{u+27a8}"  ; (➨) heavy concave-pointed black rightwards arrow
compose["7s"] := "{u+27a9}"  ; (➩) right-shaded white rightwards arrow
compose["7t"] := "{u+27aa}"  ; (➪) left-shaded white rightwards arrow
compose["7u"] := "{u+27ab}"  ; (➫) back-tilted shadowed white rightwards arrow
compose["7v"] := "{u+27ac}"  ; (➬) front-tilted shadowed white rightwards arrow
compose["7w"] := "{u+27ad}"  ; (➭) heavy lower right-shadowed white rightwards arrow
compose["7x"] := "{u+27ae}"  ; (➮) heavy upper right-shadowed white rightwards arrow
compose["7y"] := "{u+27af}"  ; (➯) notched lower right-shadowed white rightwards arrow
compose["7z"] := "{u+27b1}"  ; (➱) notched upper right-shadowed white rightwards arrow

compose["8a"] := "{u+27b2}"  ; (➲) circled heavy white rightwards arrow
compose["8b"] := "{u+27b3}"  ; (➳) white-feathered rightwards arrow
compose["8c"] := "{u+27b4}"  ; (➴) black-feathered south east arrow
compose["8d"] := "{u+27b5}"  ; (➵) black-feathered rightwards arrow
compose["8e"] := "{u+27b6}"  ; (➶) black-feathered north east arrow
compose["8f"] := "{u+27b7}"  ; (➷) heavy black-feathered south east arrow
compose["8g"] := "{u+27b8}"  ; (➸) heavy black-feathered rightwards arrow
compose["8h"] := "{u+27b9}"  ; (➹) heavy black-feathered north east arrow
compose["8i"] := "{u+27ba}"  ; (➺) teardrop-barbed rightwards arrow
compose["8j"] := "{u+27bb}"  ; (➻) heavy teardrop-shanked rightwards arrow
compose["8k"] := "{u+27bc}"  ; (➼) wedge-tailed rightwards arrow
compose["8l"] := "{u+27bd}"  ; (➽) heavy wedge-tailed rightwards arrow
compose["8m"] := "{u+27be}"  ; (➾) open-outlined rightwards arrow
compose["8n"] := "{u+27c1}"  ; (⟁) white triangle containing small white triangle


; Compose :  Dingbat Negative Circled Digits

compose["n1"] := "{u+2776}"  ; (❶) dingbat negative circled digit 1
compose["n2"] := "{u+2777}"  ; (❷) dingbat negative circled digit 2
compose["n3"] := "{u+2778}"  ; (❸) dingbat negative circled digit 3
compose["n4"] := "{u+2779}"  ; (❹) dingbat negative circled digit 4
compose["n5"] := "{u+277a}"  ; (❺) dingbat negative circled digit 5
compose["n6"] := "{u+277b}"  ; (❻) dingbat negative circled digit 6
compose["n7"] := "{u+277c}"  ; (❼) dingbat negative circled digit 7
compose["n8"] := "{u+277d}"  ; (❽) dingbat negative circled digit 8
compose["n9"] := "{u+277e}"  ; (❾) dingbat negative circled digit 9
compose["n0"] := "{u+277f}"  ; (❿) dingbat negative circled digit 10
