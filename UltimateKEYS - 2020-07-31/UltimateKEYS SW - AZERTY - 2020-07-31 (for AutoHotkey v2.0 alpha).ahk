; UltimateKEYS SW - AZERTY - 2020-07-31 (for AutoHotkey v2.0 alpha).ahk
...
dkCircumflex[chr(0x00e6)] := "{u+00e2}"  ; (æ -> â) a with circumflex
dkCircumflex[chr(0x00c6)] := "{u+00c2}"  ; (Æ -> Â) A with circumflex
...
dkRingDotAbove[chr(0x00e6)] := "{u+0227}"  ; (æ -> ȧ) a with dot above
dkRingDotAbove[chr(0x00c6)] := "{u+0226}"  ; (Æ -> Ȧ) A with dot above
...
dkRingDotAbove[chr(0x00e0)] := "{u+1e98}"  ; (à -> ẘ) w with ring above
...
dkGraveAccent[chr(0x00e6)] := "{u+20b3}"  ; (æ -> ₳) Argentine austral
dkGraveAccent[chr(0x00c6)] := "{u+20b3}"  ; (Æ -> ₳) Argentine austral
...
dkGraveAccent[chr(0x00e0)] := "{u+20a9}"  ; (à -> ₩) South Korean won
dkGraveAccent[chr(0x00c0)] := "{u+20a9}"  ; (À -> ₩) South Korean won
...
dkNotSign["A"] := "{u+00aa}"          ; (ª) feminine ordinal indicator (Spanish, Portuguese, Italian, Galician)
dkNotSign[chr(0x00e6)] := "{u+214d}"  ; (æ -> ⅍) aktieselskab
dkNotSign[chr(0x00c6)] := "{u+214d}"  ; (Æ -> ⅍) aktieselskab
...
dkNotSign["_"] := "{u+2023}"          ; (‣) triangular bullet
...
dkBrokenBar[chr(0x00e6)] := "{u+0252}"  ; (æ -> ɒ) latin small letter turned alpha
dkBrokenBar[chr(0x00c6)] := "{u+2c70}"  ; (Æ -> Ɒ) latin capital letter turned alpha
