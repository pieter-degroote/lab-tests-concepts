; UltimateKEYS - Grave Accent (for AutoHotkey v1.1).ahk - 2023-01-07
...
dkGrave.item["z"] := "{u+00e0}"  ; (à) a with grave
dkGrave.item["Z"] := "{u+00c0}"  ; (À) A with grave
dkGrave.item["x"] := "{u+00e1}"  ; (á) a with acute
dkGrave.item["X"] := "{u+00c1}"  ; (Á) A with acute
...
dkGrave.item["f"] := "{u+00e8}"  ; (è) e with grave
dkGrave.item["F"] := "{u+00c8}"  ; (È) E with grave
dkGrave.item["g"] := "{u+00e9}"  ; (é) e with acute
dkGrave.item["G"] := "{u+00c9}"  ; (É) E with acute
...
dkGrave.item["v"] := "{u+00ec}"  ; (ì) i with grave
dkGrave.item["V"] := "{u+00cc}"  ; (Ì) I with grave
dkGrave.item["b"] := "{u+00ed}"  ; (í) i with acute
dkGrave.item["B"] := "{u+00cd}"  ; (Í) I with acute
...
dkGrave.item["h"] := "{u+00f9}"  ; (ù) u with grave
dkGrave.item["H"] := "{u+00d9}"  ; (Ù) U with grave
dkGrave.item["j"] := "{u+00fa}"  ; (ú) u with acute
dkGrave.item["J"] := "{u+00da}"  ; (Ú) U with acute
...
dkGrave.item["?"] := "{u+2026}"  ; (…) horizontal ellipsis
dkGrave.item["'"] := "{u+2020}"  ; (†) dagger
dkGrave.item[chr(34)] := "{u+2021}"  ; (‡) double dagger
dkGrave.item["\"] := "{u+2002}"  ;     en space
dkGrave.item["|"] := "{u+2003}"  ;     em space
