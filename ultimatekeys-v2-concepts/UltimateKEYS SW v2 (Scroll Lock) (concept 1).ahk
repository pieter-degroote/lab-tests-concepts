; UltimateKEYS SW v2 (Scroll Lock) (concept 1).ahk - 2021-07-14
...
dkDotAbove.item[chr(0x00f5)] := "{u+1e98}"  ; (õ -> ẘ) w with ring above
...
dkMacronStroke.item["q"] := "{u+01e3}"          ; (ǣ) ae with macron
dkMacronStroke.item["Q"] := "{u+01e2}"          ; (Ǣ) AE with macron
...
dkMacronStroke.item[chr(0x00f8)] := "{u+1e3b}"  ; (ô -> ḻ) l with line below
dkMacronStroke.item[chr(0x00d8)] := "{u+1e3a}"  ; (Ô -> Ḻ) L with line below
dkMacronStroke.item["o"] := "{u+014d}"          ; (ō) o with macron
dkMacronStroke.item["O"] := "{u+014c}"          ; (Ō) O with macron
dkMacronStroke.item[chr(0x00f4)] := "{u+01ed}"  ; (ö -> ǭ) o with ogonek and macron
dkMacronStroke.item[chr(0x00d4)] := "{u+01ec}"  ; (Ö -> Ǭ) O with ogonek and macron
...
dkBreveSpecial.item[chr(0x00f5)] := "{u+2c73}"  ; (õ -> ⱳ) w with hook
dkBreveSpecial.item[chr(0x00d5)] := "{u+2c72}"  ; (Õ -> Ⱳ) W with hook
...
dkAcuteAccent.item[chr(0x00e4)] := "{u+0251}"  ; (ä -> ɑ) latin small letter alpha
dkAcuteAccent.item[chr(0x00c4)] := "{u+2c6d}"  ; (Ä -> Ɑ) latin capital letter alpha
...
dkAcuteAccent.item[chr(0x00eb)] := "{u+025b}"  ; (ë -> ɛ) small open e (latin small epsilon)
dkAcuteAccent.item[chr(0x00cb)] := "{u+0190}"  ; (Ë -> Ɛ) capital open E (latin capital epsilon)
...
dkAcuteAccent.item[chr(0x00ea)] := "{u+027d}"  ; (ê -> ɽ) r with tail
dkAcuteAccent.item[chr(0x00ca)] := "{u+2c64}"  ; (Ê -> Ɽ) R with tail
...
dkAcuteAccent.item[chr(0x00f5)] := "{u+01fb}"  ; (õ -> ǻ) a with ring above and acute
dkAcuteAccent.item[chr(0x00d5)] := "{u+01fa}"  ; (Õ -> Ǻ) A with ring above and acute
dkAcuteAccent.item[chr(0x00e3)] := "{u+01fd}"  ; (ã -> ǽ) ae with acute
dkAcuteAccent.item[chr(0x00c3)] := "{u+01fc}"  ; (Ã -> Ǽ) AE with acute
dkAcuteAccent.item[chr(0x00f4)] := "{u+01ff}"  ; (ô -> ǿ) o with stroke and acute
dkAcuteAccent.item[chr(0x00d4)] := "{u+01fe}"  ; (Ô -> Ǿ) O with stroke and acute
...
dkGraveAccent.item["a"] := "{u+00e5}"  ; (å) a with ring above
dkGraveAccent.item["A"] := "{u+00c5}"  ; (Å) A with ring above
dkGraveAccent.item["d"] := "{u+00f0}"  ; (ð) small letter eth
dkGraveAccent.item["D"] := "{u+00d0}"  ; (Ð) capital letter eth
dkGraveAccent.item["e"] := "{u+00e6}"  ; (æ) letter ae
dkGraveAccent.item["E"] := "{u+00c6}"  ; (Æ) letter AE
dkGraveAccent.item["g"] := "{u+ab36}"  ; (ꬶ) cross-tailed g
dkGraveAccent.item["h"] := "{u+0267}"  ; (ɧ) small letter heng with hook
...
dkGraveAccent.item["o"] := "{u+00f8}"  ; (ø) o with stroke
dkGraveAccent.item["O"] := "{u+00d8}"  ; (Ø) O with stroke
dkGraveAccent.item["s"] := "{u+0283}"  ; (ʃ) small letter esh
dkGraveAccent.item["S"] := "{u+01a9}"  ; (Ʃ) capital letter esh
...
dkGraveAccent.item[chr(0x00df)] := "{u+017f}"  ; (ß -> ſ) small long s
...
dkTilde.item["c"] := "{u+2663}"  ; (♣) black club suit
dkTilde.item["C"] := "{u+2667}"  ; (♧) white club suit
dkTilde.item["d"] := "{u+2666}"  ; (♦) black diamond suit
dkTilde.item["D"] := "{u+2662}"  ; (♢) white diamond suit
dkTilde.item["h"] := "{u+2665}"  ; (♥) black heart suit
dkTilde.item["H"] := "{u+2661}"  ; (♡) white heart suit
dkTilde.item["s"] := "{u+2660}"  ; (♠) black spade suit
dkTilde.item["S"] := "{u+2664}"  ; (♤) white spade suit
...
dkBrokenBar.item[chr(0x00f4)] := "{u+20a4}"  ; (ô -> ₤) lira
dkBrokenBar.item[chr(0x00d4)] := "{u+20b6}"  ; (Ô -> ₶) livre tournois
