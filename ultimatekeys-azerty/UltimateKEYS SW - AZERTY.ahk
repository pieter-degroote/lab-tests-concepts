; UltimateKEYS SW - AZERTY.ahk - 2021-07-26
...
dkDotAbove.item[chr(0x00e0)] := "{u+1e98}"  ; (à -> ẘ) w with ring above
...
dkBreveSpecial.item[chr(0x00e0)] := "{u+2c73}"  ; (à -> ⱳ) w with hook
dkBreveSpecial.item[chr(0x00c0)] := "{u+2c72}"  ; (À -> Ⱳ) W with hook
...
dkGeneral.item["A"] := "{u+00aa}"          ; (ª) feminine ordinal indicator (Spanish, Portuguese, Italian, Galician)
dkGeneral.item[chr(0x00e6)] := "{u+214d}"  ; (æ -> ⅍) aktieselskab
dkGeneral.item[chr(0x00c6)] := "{u+214d}"  ; (Æ -> ⅍) aktieselskab
