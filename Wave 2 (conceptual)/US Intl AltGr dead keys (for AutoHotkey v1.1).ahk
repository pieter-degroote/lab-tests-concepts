...
dkDoubleAcute.item["g"] := "{u+1e21}"  ; (ḡ) g with macron
dkDoubleAcute.item["G"] := "{u+1e20}"  ; (Ḡ) G with macron
dkDoubleAcute.item["i"] := "{u+0268}"  ; (ɨ) i with stroke
dkDoubleAcute.item["I"] := "{u+0197}"  ; (Ɨ) I with stroke
dkDoubleAcute.item["l"] := "{u+019a}"  ; (ƚ) l with bar
dkDoubleAcute.item["L"] := "{u+023d}"  ; (Ƚ) L with bar
dkDoubleAcute.item["o"] := "{u+0151}"  ; (ő) o with double acute
dkDoubleAcute.item["O"] := "{u+0150}"  ; (Ő) O with double acute
dkDoubleAcute.item["p"] := "{u+0275}"  ; (ɵ) barred o
dkDoubleAcute.item["P"] := "{u+019f}"  ; (Ɵ) O with middle tilde
dkDoubleAcute.item["u"] := "{u+0171}"  ; (ű) u with double acute
dkDoubleAcute.item["U"] := "{u+0170}"  ; (Ű) U with double acute
dkDoubleAcute.item["v"] := "{u+0289}"  ; (ʉ) u with bar
dkDoubleAcute.item["V"] := "{u+0244}"  ; (Ʉ) U with bar
dkDoubleAcute.item["y"] := "{u+024f}"  ; (ɏ) y with stroke
dkDoubleAcute.item["Y"] := "{u+024e}"  ; (Ɏ) Y with stroke
dkDoubleAcute.item[" "] := "{u+02dd}"  ; (˝) double acute accent


; Dead Key :  Macron and Stroke

global dkMacronStroke := ComObjCreate("Scripting.Dictionary")
...
dkMacronStroke.item["g"] := "{u+01e5}"  ; (ǥ) g with stroke
dkMacronStroke.item["G"] := "{u+01e4}"  ; (Ǥ) G with stroke
dkMacronStroke.item["h"] := "{u+0127}"  ; (ħ) h with stroke
dkMacronStroke.item["H"] := "{u+0126}"  ; (Ħ) H with stroke
...
dkMacronStroke.item["q"] := "{u+01ed}"  ; (ǭ) o with ogonek and macron
dkMacronStroke.item["Q"] := "{u+01ec}"  ; (Ǭ) O with ogonek and macron
...
global dkCedillaOgonek := ComObjCreate("Scripting.Dictionary")
...
dkCedillaOgonek.item["q"] := "{u+01ed}"  ; (ǭ) o with ogonek and macron
dkCedillaOgonek.item["Q"] := "{u+01ec}"  ; (Ǭ) O with ogonek and macron
...
global dkHook := ComObjCreate("Scripting.Dictionary")
...
dkHook.item["e"] := "{u+025a}"  ; (ɚ) small letter schwa with hook
...
dkHook.item["j"] := "{u+0267}"  ; (ɧ) small letter heng with hook
dkHook.item["k"] := "{u+0199}"  ; (ƙ) k with hook
dkHook.item["K"] := "{u+0198}"  ; (Ƙ) K with hook
dkHook.item["l"] := "{u+026c}"  ; (ɬ) l with belt
dkHook.item["L"] := "{u+a7ad}"  ; (Ɬ) L with belt
...
dkHook.item["o"] := "{u+01a1}"  ; (ơ) o with horn
dkHook.item["O"] := "{u+01a0}"  ; (Ơ) O with horn
...
dkHook.item["s"] := "{u+0282}"  ; (ʂ) s with hook
dkHook.item["t"] := "{u+01ad}"  ; (ƭ) t with hook
dkHook.item["T"] := "{u+01ac}"  ; (Ƭ) T with hook
dkHook.item["u"] := "{u+01b0}"  ; (ư) u with horn
dkHook.item["U"] := "{u+01af}"  ; (Ư) U with horn
...
global dkBreveSpecial := ComObjCreate("Scripting.Dictionary")
...
dkBreveSpecial.item["f"] := "{u+0259}"  ; (ə) small letter schwa
dkBreveSpecial.item["F"] := "{u+018f}"  ; (Ə) capital letter schwa
...
dkBreveSpecial.item["s"] := "{u+0219}"  ; (ș) s with comma below
dkBreveSpecial.item["S"] := "{u+0218}"  ; (Ș) S with comma below
dkBreveSpecial.item["t"] := "{u+021b}"  ; (ț) t with comma below
dkBreveSpecial.item["T"] := "{u+021a}"  ; (Ț) T with comma below
...
global dkDotBelow := ComObjCreate("Scripting.Dictionary")
dkDotBelow.item["a"] := "{u+1ea1}"  ; (ạ) a with dot below
dkDotBelow.item["A"] := "{u+1ea0}"  ; (Ạ) A with dot below
dkDotBelow.item["b"] := "{u+1e05}"  ; (ḅ) b with dot below
dkDotBelow.item["B"] := "{u+1e04}"  ; (Ḅ) B with dot below
dkDotBelow.item["d"] := "{u+1e0d}"  ; (ḍ) d with dot below
dkDotBelow.item["D"] := "{u+1e0c}"  ; (Ḍ) D with dot below
dkDotBelow.item["e"] := "{u+1eb9}"  ; (ẹ) e with dot below
dkDotBelow.item["E"] := "{u+1eb8}"  ; (Ẹ) E with dot below
dkDotBelow.item["h"] := "{u+1e25}"  ; (ḥ) h with dot below
dkDotBelow.item["H"] := "{u+1e24}"  ; (Ḥ) H with dot below
dkDotBelow.item["i"] := "{u+1ecb}"  ; (ị) i with dot below
dkDotBelow.item["I"] := "{u+1eca}"  ; (Ị) I with dot below
dkDotBelow.item["k"] := "{u+1e33}"  ; (ḳ) k with dot below
dkDotBelow.item["K"] := "{u+1e32}"  ; (Ḳ) K with dot below
dkDotBelow.item["l"] := "{u+1e37}"  ; (ḷ) l with dot below
dkDotBelow.item["L"] := "{u+1e36}"  ; (Ḷ) L with dot below
dkDotBelow.item["m"] := "{u+1e43}"  ; (ṃ) m with dot below
dkDotBelow.item["M"] := "{u+1e42}"  ; (Ṃ) M with dot below
dkDotBelow.item["n"] := "{u+1e47}"  ; (ṇ) n with dot below
dkDotBelow.item["N"] := "{u+1e46}"  ; (Ṇ) N with dot below
dkDotBelow.item["o"] := "{u+1ecd}"  ; (ọ) o with dot below
dkDotBelow.item["O"] := "{u+1ecc}"  ; (Ọ) O with dot below
dkDotBelow.item["r"] := "{u+1e5b}"  ; (ṛ) r with dot below
dkDotBelow.item["R"] := "{u+1e5a}"  ; (Ṛ) R with dot below
dkDotBelow.item["s"] := "{u+1e63}"  ; (ṣ) s with dot below
dkDotBelow.item["S"] := "{u+1e62}"  ; (Ṣ) S with dot below
dkDotBelow.item["t"] := "{u+1e6d}"  ; (ṭ) t with dot below
dkDotBelow.item["T"] := "{u+1e6c}"  ; (Ṭ) T with dot below
dkDotBelow.item["u"] := "{u+1ee5}"  ; (ụ) u with dot below
dkDotBelow.item["U"] := "{u+1ee4}"  ; (Ụ) U with dot below
dkDotBelow.item["v"] := "{u+1e7f}"  ; (ṿ) v with dot below
dkDotBelow.item["V"] := "{u+1e7e}"  ; (Ṿ) V with dot below
dkDotBelow.item["w"] := "{u+1e89}"  ; (ẉ) w with dot below
dkDotBelow.item["W"] := "{u+1e88}"  ; (Ẉ) W with dot below
dkDotBelow.item["y"] := "{u+1ef5}"  ; (ỵ) y with dot below
dkDotBelow.item["Y"] := "{u+1ef4}"  ; (Ỵ) Y with dot below
dkDotBelow.item["z"] := "{u+1e93}"  ; (ẓ) z with dot below
dkDotBelow.item["Z"] := "{u+1e92}"  ; (Ẓ) Z with dot below
...
<^>!+sc004::
  ih := InputHook("L1", gEndKeys)
  ih.Start(), ih.Wait()
  Send % dkMacronStroke.item[ih.Input]
  return
...
<^>!+sc006::
  ih := InputHook("L1", gEndKeys)
  ih.Start(), ih.Wait()
  Send % dkCedillaOgonek.item[ih.Input]
  return
...
<^>!+sc00A::
  ih := InputHook("L1", gEndKeys)
  ih.Start(), ih.Wait()
  Send % dkBreveSpecial.item[ih.Input]
  return
