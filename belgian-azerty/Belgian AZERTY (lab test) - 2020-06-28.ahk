; Belgian AZERTY (lab test) - 2020-06-28.ahk
...
; dkCircumflex.item[chr(0x00e6)] := "{u+00e2}"  ; (æ -> â) a with circumflex
; dkCircumflex.item[chr(0x00c6)] := "{u+00c2}"  ; (Æ -> Â) A with circumflex
...
; dkRingDotAbove.item[chr(0x00e6)] := "{u+0227}"  ; (æ -> ȧ) a with dot above
; dkRingDotAbove.item[chr(0x00c6)] := "{u+0226}"  ; (Æ -> Ȧ) A with dot above
...
; dkRingDotAbove.item[chr(0x00e0)] := "{u+1e98}"  ; (à -> ẘ) w with ring above
...
dkGraveAccent.item[chr(0x00e6)] := "{u+20b3}"  ; (æ -> ₳) Argentine austral
dkGraveAccent.item[chr(0x00c6)] := "{u+20b3}"  ; (Æ -> ₳) Argentine austral
...
dkGraveAccent.item[chr(0x00e0)] := "{u+20a9}"  ; (à -> ₩) South Korean won
dkGraveAccent.item[chr(0x00c0)] := "{u+20a9}"  ; (À -> ₩) South Korean won
...
dkGraveAccent.item["2"] := "{u+2001}"  ; em quad
...
; dkNotSign.item["A"] := "{u+00aa}"          ; (ª) feminine ordinal indicator (Spanish, Portuguese, Italian, Galician)
; dkNotSign.item[chr(0x00e6)] := "{u+214d}"  ; (æ -> ⅍) aktieselskab
; dkNotSign.item[chr(0x00c6)] := "{u+214d}"  ; (Æ -> ⅍) aktieselskab
...
; dkNotSign.item["!"] := "{u+2190}"          ; (←) leftwards arrow
; dkNotSign.item["@"] := "{u+2193}"          ; (↓) downwards arrow
; dkNotSign.item["#"] := "{u+2191}"          ; (↑) upwards arrow
; dkNotSign.item["$"] := "{u+2192}"          ; (→) rightwards arrow
; dkNotSign.item["%"] := "{u+2196}"          ; (↖) north west arrow
; dkNotSign.item["^"] := "{u+2199}"          ; (↙) south west arrow
; dkNotSign.item["&"] := "{u+2197}"          ; (↗) north east arrow
; dkNotSign.item["*"] := "{u+2198}"          ; (↘) south east arrow
; dkNotSign.item["("] := "{u+2195}"          ; (↕) up down arrow
; dkNotSign.item[")"] := "{u+21a8}"          ; (↨) up down arrow with base
...
; dkNotSign.item["8"] := "{u+21d8}"          ; (⇘) south east double arrow
; dkNotSign.item["9"] := "{u+21d5}"          ; (⇕) up down double arrow
; dkNotSign.item["0"] := "{u+21b2}"          ; (↲) downwards arrow with tip leftwards
...
; dkBrokenBar.item[chr(0x00e6)] := "{u+0252}"  ; (æ -> ɒ) latin small letter turned alpha
; dkBrokenBar.item[chr(0x00c6)] := "{u+2c70}"  ; (Æ -> Ɒ) latin capital letter turned alpha
...
; dkBrokenBar.item["!"] := "{u+2116}"  ; (№) numero sign
; dkBrokenBar.item["1"] := "{u+2116}"  ; (№) numero sign
; dkBrokenBar.item["@"] := "{u+00bd}"  ; (½) vulgar fraction 1/2
; dkBrokenBar.item["2"] := "{u+00bd}"  ; (½) vulgar fraction 1/2
; dkBrokenBar.item["#"] := "{u+2153}"  ; (⅓) vulgar fraction 1/3
; dkBrokenBar.item["3"] := "{u+2153}"  ; (⅓) vulgar fraction 1/3
; dkBrokenBar.item["$"] := "{u+00bc}"  ; (¼) vulgar fraction 1/4
; dkBrokenBar.item["4"] := "{u+00bc}"  ; (¼) vulgar fraction 1/4
; dkBrokenBar.item["%"] := "{u+2154}"  ; (⅔) vulgar fraction 2/3
; dkBrokenBar.item["5"] := "{u+2154}"  ; (⅔) vulgar fraction 2/3
; dkBrokenBar.item["^"] := "{u+00be}"  ; (¾) vulgar fraction 3/4
; dkBrokenBar.item["6"] := "{u+00be}"  ; (¾) vulgar fraction 3/4
; dkBrokenBar.item["&"] := "{u+215b}"  ; (⅛) vulgar fraction 1/8
; dkBrokenBar.item["7"] := "{u+215b}"  ; (⅛) vulgar fraction 1/8
; dkBrokenBar.item["*"] := "{u+215c}"  ; (⅜) vulgar fraction 3/8
; dkBrokenBar.item["8"] := "{u+215c}"  ; (⅜) vulgar fraction 3/8
; dkBrokenBar.item["("] := "{u+215d}"  ; (⅝) vulgar fraction 5/8
; dkBrokenBar.item["9"] := "{u+215d}"  ; (⅝) vulgar fraction 5/8
; dkBrokenBar.item[")"] := "{u+215e}"  ; (⅞) vulgar fraction 7/8
...
$2::Send {u+00e9}  ; (é) e with acute
$+2::Send 2        ; digit 2
>!2::Send @        ; at sign

$3::Send `"        ; quotation mark
$+3::Send 3        ; digit 3
>!3::Send {#}      ; number sign
...
$5::Send (         ; left parenthesis
$+5::Send 5        ; digit 5
>!5::Send {{}      ; left curly bracket

$6::Send {u+00a7}  ; (§) section sign
$+6::Send 6        ; digit 6
>!6::Send {^}      ; circumflex accent

$7::Send {u+00e8}  ; (è) e with grave
$+7::Send 7        ; digit 7

$8::Send {!}       ; exclamation mark
$+8::Send 8        ; digit 8

$9::Send {u+00e7}  ; (ç) c with cedilla
$+9::Send 9        ; digit 9
>!9::Send {{}      ; left curly bracket

$0::Send {u+00e0}  ; (à) a with grave
$+0::Send 0        ; digit 0
