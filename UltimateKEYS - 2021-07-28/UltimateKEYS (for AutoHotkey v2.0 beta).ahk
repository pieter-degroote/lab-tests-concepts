; UltimateKEYS (for AutoHotkey v2.0 beta).ahk - 2021-07-28
...
dkAcuteAccent["e"] := "{u+025b}"  ; (ɛ) small open e (latin small epsilon)
dkAcuteAccent["E"] := "{u+0190}"  ; (Ɛ) capital open E (latin capital epsilon)
...
dkGraveAccent["o"] := "{u+01a1}"  ; (ơ) o with horn
dkGraveAccent["O"] := "{u+01a0}"  ; (Ơ) O with horn
dkGraveAccent["t"] := "{u+00fe}"  ; (þ) small letter thorn
dkGraveAccent["T"] := "{u+00de}"  ; (Þ) capital letter thorn
dkGraveAccent["u"] := "{u+01b0}"  ; (ư) u with horn
dkGraveAccent["U"] := "{u+01af}"  ; (Ư) U with horn
...
>!\:: {
  ...
  ih.Start()
  ih.Wait()
  if dkGeneral.Has(ih.Input)
    Send dkGeneral[ih.Input]
  Send "{blind}{vkE8}"
}
>!|:: {
  Send "{blind}{vkE8}"
