; Polish Programmers Keyboard - SW (Scroll Lock).ahk - 2021-07-10
...
dkAcuteAccent.item[chr(0x017b)] := "{u+0224}"  ; (Ż -> Ȥ) Z with hook
...
dkGreekAlphabet.item[chr(0x015b)] := "{u+03c2}"  ; (ś -> ς) small sigma, in word-final position
