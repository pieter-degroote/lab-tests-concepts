...
dkAcuteAccent.item["e"] := "{u+025b}"  ; (ɛ) small open e (latin small epsilon)
dkAcuteAccent.item["E"] := "{u+0190}"  ; (Ɛ) capital open E (latin capital epsilon)
...
dkGraveAccent.item["o"] := "{u+01a1}"  ; (ơ) o with horn
dkGraveAccent.item["O"] := "{u+01a0}"  ; (Ơ) O with horn
dkGraveAccent.item["t"] := "{u+00fe}"  ; (þ) small letter thorn
dkGraveAccent.item["T"] := "{u+00de}"  ; (Þ) capital letter thorn
dkGraveAccent.item["u"] := "{u+01b0}"  ; (ư) u with horn
dkGraveAccent.item["U"] := "{u+01af}"  ; (Ư) U with horn
